...
public:
    ...
    bool updateClient(const QString &company_name, const QString &country,const QString & contact_name ,const QString &address, const QString &city, const QString &state, const QString &email, const QString &phone, const QString &website, const QString &tin,const QString& client_id);
    QSqlDatabase openDb(const QString &driver, const QString &name) const;
    QStringList sqlExecute(const QString& client_id);
     ~dbconnector();
